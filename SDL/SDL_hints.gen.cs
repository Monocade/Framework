...
namespace Engine.SDL3
{
    ...
    internal unsafe delegate void SDL_HintCallback(void* userdata, byte* name, byte* oldValue, byte* newValue);
    ...
    internal static unsafe partial class SDL
    {
        ...
        private static extern SDL_Bool iSDL_AddHintCallback(byte* name, IntPtr callback, void* userdata);

        [DllImport("SDL3", CallingConvention = CallingConvention.Cdecl, EntryPoint = "SDL_RemoveHintCallback", ExactSpelling = true)]
        private static extern void iSDL_RemoveHintCallback(byte* name, IntPtr callback, void* userdata);
