...
namespace Engine
{
    public sealed unsafe class FileDialogProvider(App app, string path, string name = null, string extensions = null, bool multiple = true) : DialogProvider
    {
        ...
        public override void Open(Dialog.DialogCallback callback)
        {
            ...
            SDL_ShowOpenFileDialog(Callback, Native.ObjectToNative(context), app.Window.Handle, [context.Filter], 1, path, multiple);
        }
    }
}