...
namespace Engine
{
    ...
    public sealed unsafe partial class UserStorageProvider(string app, string name) : StorageProvider
    {
        private SDL_Storage* Handle = SDL_OpenUserStorage(app, name, 0);
    ...
    // Directory
    public unsafe partial class UserStorageProvider
    {
